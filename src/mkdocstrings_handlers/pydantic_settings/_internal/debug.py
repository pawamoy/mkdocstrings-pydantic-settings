...
def _get_version(dist: str = "mkdocstrings-pydantic-settings") -> str:
...
def _get_debug_info() -> _Environment:
    ...
    packages = ["mkdocstrings-pydantic-settings"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("MKDOCSTRINGS_PYDANTIC_SETTINGS")]]
    return _Environment(
